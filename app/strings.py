...
SIGNUP_CONFIRM_ECHO_TEXT = "Ты ввел: {dialog_data[user_additional]}. Всё верно?"
...
GET_PREVIOUS_USER_ACTION_NOTIFY_TEXT = "Тебя ищет {user} по поводу твоей последней записи в {place}."
